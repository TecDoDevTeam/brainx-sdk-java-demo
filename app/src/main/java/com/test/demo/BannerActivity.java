...
public class BannerActivity extends AppCompatActivity implements TDBannerLoadListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_320_50).setOnClickListener(view -> TDBanner.load(DemoActivity.BANNER_320_50_UNIT_ID, new TDBannerConfig(), BannerActivity.this));
        findViewById(R.id.btn_300_250).setOnClickListener(view -> TDBanner.load(DemoActivity.BANNER_300_250_UNIT_ID, new TDBannerConfig(), BannerActivity.this));
        findViewById(R.id.btn_320_90).setOnClickListener(view -> TDBanner.load(DemoActivity.BANNER_320_90_UNIT_ID, new TDBannerConfig(), BannerActivity.this));
        findViewById(R.id.btn_728_90).setOnClickListener(view -> TDBanner.load(DemoActivity.BANNER_728_90_UNIT_ID, new TDBannerConfig(), BannerActivity.this));
        findViewById(R.id.btn_800_600).setOnClickListener(view -> TDBanner.load(DemoActivity.BANNER_800_600_UNIT_ID, new TDBannerConfig(), BannerActivity.this));
    }
